...
const CommentList = ({ match, history, comments, posts, reports, users, loadAllReportsAction }) => {
    ...
    const recomposeReports = () => {
        ...
        for (let report of reports) {
            ...
            report_item['user'] = { id: report.user_id, name: getUserNameById(report.user_id) };

            // add new field 'parent';
            report_item['parent'] = { type: report_item.type, target_id: report_item.target_id };

            report_item['action'] = {id: report.id, email: getEmailById(report.user_id)};
...
const mapStateToProps = ({ comments: commentApp, posts: postApp, users: userApp, reports: reportApp }) => {
